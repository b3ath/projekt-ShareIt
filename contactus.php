        ...
        <div class="screen-body-item">
          <div class="app-form">
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Jméno a Přijímení">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" placeholder="E-mail">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Telefoní číslo">
            </div>
            <div class="app-form-group message">
              <input class="app-form-control" placeholder="Obsah zprávy">
            </div>
